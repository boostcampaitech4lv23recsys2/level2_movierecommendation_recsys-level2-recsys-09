...
#확인하기 위함입니다.
def split_train_test_proportion(data, test_prop=0.2, seed=42):
...
def preprocess(path, seed=42):
    ...
    # Shuffle and split train, valid, test
    ...
    vad_plays_tr, vad_plays_te = split_train_test_proportion(vad_plays,test_prop=0.2, seed=seed)

    test_plays = raw_data.loc[raw_data['user'].isin(te_users)]
    test_plays = test_plays.loc[test_plays['item'].isin(unique_sid)]
    test_plays_tr, test_plays_te = split_train_test_proportion(test_plays, test_prop=0.2, seed=seed)


    # save at data/train/pros_sg/
